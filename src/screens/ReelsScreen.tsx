...
export function ReelsScreen() {
  ...
  const reelHeight = Math.max(520, height - spacing.navHeight);
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: colors.black, marginTop: -80 },
  ...
  topOverlay: { position: 'absolute', top: 100, left: 20, right: 20 },
  ...
  bottomCopy: { position: 'absolute', left: 20, right: 62, bottom: 87 },
  ...
  actions: { position: 'absolute', right: 12, bottom: 155, alignItems: 'center', gap: 20 },
