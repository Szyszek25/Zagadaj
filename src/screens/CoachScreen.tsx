...
const styles = StyleSheet.create({
  ...
  scenarioLabel: { color: colors.teal, fontFamily: fonts.bold, fontSize: 13, marginRight: 6 },
  scenarioValue: { flex: 1, color: colors.ink, fontFamily: fonts.regular, fontSize: 13 },
  chevron: { color: colors.muted, fontFamily: fonts.semibold, fontSize: 16, marginLeft: 8 },
  ...
  avatarText: { color: colors.teal, fontFamily: fonts.bold, fontSize: 13 },
