...
const styles = StyleSheet.create({
  ...
  content: { paddingHorizontal: spacing.page, paddingBottom: spacing.navHeight + 26 },
  ...
  brand: { color: colors.ink, fontSize: 29, lineHeight: 38, fontWeight: '800', letterSpacing: -0.8 },
  ...
  tab: { color: colors.muted, fontSize: 14, fontWeight: '600' },
  tabActive: { color: colors.teal },
  tabLine: { width: 28, height: 3, borderRadius: 2, backgroundColor: colors.teal, marginTop: 10 },
  kicker: { marginTop: 34, color: colors.muted, fontSize: 11, fontWeight: '700', letterSpacing: 0.7 },
  title: { marginTop: 12, color: colors.ink, fontSize: 35, lineHeight: 40, fontWeight: '800', letterSpacing: -1.15 },
  description: { marginTop: 16, color: colors.ink, fontSize: 20, lineHeight: 29, fontWeight: '400' },
  accent: { color: colors.teal, fontWeight: '700' },
  opener: { marginTop: 26, minHeight: 118, flexDirection: 'row', borderRadius: 24, backgroundColor: colors.tealSoft, padding: 20 },
  quote: { color: colors.teal, fontSize: 36, fontWeight: '800', marginRight: 12, marginTop: -3 },
  openerText: { flex: 1, color: colors.ink, fontSize: 20, lineHeight: 28, fontWeight: '600' },
  support: { marginTop: 20, color: colors.muted, fontSize: 15 },
  ...
  secondaryTitle: { marginTop: 34, color: colors.ink, fontSize: 17, fontWeight: '700' },
  secondaryRow: { marginTop: 20, flexDirection: 'row', justifyContent: 'space-between' },
  secondaryAction: { color: colors.ink, fontSize: 16, fontWeight: '600' },
  divider: { marginTop: 18, height: StyleSheet.hairlineWidth, backgroundColor: colors.line },
  micro: { marginTop: 14, color: colors.muted, fontSize: 13 },
});
